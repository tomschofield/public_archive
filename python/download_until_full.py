...
#reads a very long list of nouns from a file generated by 'generate_noun_list.py'
...
#makes a europeanna api call to get big images on a search term
...
#returns free space for relevant drive
...
#holds the loop until the threshold file space is achieved
...
#main function - downloads image and metadata from url untli hard disk free space threshold is reached
